...
RUN apk add --update --no-cache busybox-extras tcpdump ca-certificates openssl-dev openssl python2-dev python2 py2-pip py2-yaml libffi-dev gcc musl-dev wget && \
